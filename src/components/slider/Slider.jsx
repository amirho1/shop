...
export default function Slider() {
    ...
    return (
      <>
        ...
        <div className="slider">
          ...
          <img src={data[pictureNumber].image} alt={data[pictureNumber].title} className="slider-image" />
  ...
  return (
    <Fetch url="https://fakestoreapi.com/products?limit=5" renderSuccess={Slide} />
  )
}
